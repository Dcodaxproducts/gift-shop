...
import { Coffee, ImagePlus, Package, ShieldCheck, Sparkles } from "lucide-react";
      ...
      <section className="grid gap-5 xl:grid-cols-[320px_minmax(0,1fr)]">
        <SectionCard icon={ImagePlus} title="Gift Media">
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-slate-50">
            <div className="flex aspect-[4/4.5] items-center justify-center bg-[radial-gradient(circle_at_top,#f7efe5_0%,#eadbc6_48%,#dcc4a5_100%)] p-6">
              <div className="flex h-full w-full items-center justify-center rounded-[28px] border border-white/70 bg-white/35 shadow-inner">
                <div className="relative flex items-center justify-center">
                  <div className="absolute -right-8 top-2 h-20 w-20 rounded-full bg-[#6f4e37]/12 blur-xl" />
                  <div className="absolute -left-10 bottom-0 h-24 w-24 rounded-full bg-[#c08c52]/12 blur-xl" />
                  <div className="flex items-end gap-3">
                    <div className="flex size-24 items-center justify-center rounded-[28px] bg-[#5f422e] text-white shadow-lg shadow-[#5f422e]/20">
        ...
        <SectionCard icon={Package} title="Product Details">
          <div className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="gift-inventory">Inventory</Label>
                <Input id="gift-inventory" defaultValue="48" className="h-11! rounded-xl bg-slate-50 text-xs" />
              </div>
              <div className="space-y-2">
        ...
        <div className="space-y-5">
          <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-4">
            <div>
              ...
              <p className="mt-1 text-[11px] text-slate-400">Make this gift visible on the storefront</p>
            </div>
          ...
          <div className="space-y-2">
            ...
            <Select defaultValue="wellnesshub">
              <SelectTrigger className="h-11 w-full rounded-xl bg-slate-50 text-xs sm:w-[260px]">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div>
            <div className="mb-2.5 flex items-center gap-2.5">
              ...
              <h3 className="text-sm font-bold text-slate-950">Active Tags</h3>
            </div>
