      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_230px]">
          ...
          <Card className="rounded-xl border border-border bg-white p-5 shadow-sm">
            <div className="grid gap-5 md:grid-cols-[88px_minmax(0,1fr)]">
              <div className="relative size-[86px]">
                <span className="flex size-[86px] items-center justify-center overflow-hidden rounded-full capitalize border border-[#a9b8e8] bg-[#d9e5df] text-xl font-semibold text-slate-700">
                  {isLoading ? "" : getInitials(`${user?.firstName} ${user?.lastName}`)}
                </span>
                <span
                  className={cn(
                    "absolute bottom-1 right-0 size-3.5 rounded-full border-2 border-white bg-emerald-500"
                  )}
                />
              </div>
              <div className="min-w-0">
        ...
        <aside className="space-y-5 xl:w-[230px]">
          ...
          <Card className="rounded-xl border border-[#e0d7ff] bg-[#f1eaff] shadow-sm">
            <CardHeader className="p-4 pb-3">
              <CardTitle className="text-[12px] font-semibold text-primary">Subscription Overview</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 px-4 pb-4">
